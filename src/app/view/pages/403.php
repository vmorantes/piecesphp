...
<body>
    <div class="content-403">
        ...
        <p class="title-403">Algo está mal aquí</h1>
            <p class="text-403">El enlace al que intenta ingresar no está disponible para su acceso.</p>
            <a class="ui button bt-403" href="<?=isset($url) && is_string($url) ? $url : base_url();?>">Ir a
                Inicio</a>
    </div>
</body>
