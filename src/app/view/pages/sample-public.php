...
<div class="elements-container centered fit">
    ...
    <p class="text-align-c">P - Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error aliquid unde iste ab id,
        pariatur sed neque fuga obcaecati eos. Magni eligendi libero odit debitis ratione dicta numquam accusamus ullam,
    ...
    <p class="text-align-l">P - Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error aliquid unde iste ab id,
        pariatur sed neque fuga obcaecati eos. Magni eligendi libero odit debitis ratione dicta numquam accusamus ullam,
        quaerat aspernatur nobis placeat, ducimus harum fugiat voluptatum quibusdam porro natus, beatae alias iure
        commodi officia vel itaque.</p>

    <p class="text-align-r">P - Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error aliquid unde iste ab id,
        pariatur sed neque fuga obcaecati eos. Magni eligendi libero odit debitis ratione dicta numquam accusamus ullam,
        quaerat aspernatur nobis placeat, ducimus harum fugiat voluptatum quibusdam porro natus, beatae alias iure
        commodi officia vel itaque.</p>

    <p class="text-align-j">P - Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error aliquid unde iste ab id,
        pariatur sed neque fuga obcaecati eos. Magni eligendi libero odit debitis ratione dicta numquam accusamus ullam,
        quaerat aspernatur nobis placeat, ducimus harum fugiat voluptatum quibusdam porro natus, beatae alias iure
        commodi officia vel itaque.</p>
    ...
    <ul class="pcs-list">
        ...
        <li>Assumenda incidunt, unde laborum porro error cupiditate quidem corporis nam consectetur blanditiis quas?
            Maiores, ullam expedita! Recusandae voluptates fugit odio! Suscipit molestias voluptates enim nam quo error
            laborum ratione dolor?</li>

        <li>Unde ullam esse iusto aperiam exercitationem amet sapiente impedit nisi alias similique animi facere sunt
            excepturi, aut pariatur porro. Exercitationem, dicta iure. Natus quis placeat magni ea animi nisi
            reiciendis!</li>

        <li>Molestiae repudiandae ut ullam aliquam nobis officia dolores est ab ipsa voluptates asperiores amet, eaque
            praesentium ducimus natus. Repellat nihil et totam ducimus est quae hic ex optio esse illo!</li>

        <li>Id architecto quia maiores quo nulla iusto doloremque, iste numquam, ipsum rerum assumenda sapiente culpa
    ...
    <ol class="pcs-list">
        ...
        <li>Aliquam placeat adipisci alias soluta suscipit excepturi velit sapiente repudiandae sequi eveniet commodi,
            quod facere explicabo quis esse officia ipsa. Molestias voluptates doloribus dolores pariatur illo officia
            numquam fuga dignissimos?</li>

        <li>Perferendis laboriosam totam placeat enim. Nemo, neque distinctio? Molestias dolore maxime sunt voluptatem
        ...
        <li>Accusamus error nostrum assumenda, eligendi, quod est rerum saepe nulla dignissimos eos tempore. Perferendis
            doloremque dicta quasi repudiandae iste vero porro placeat excepturi optio quos. Accusamus placeat et quis
            cumque.</li>

        <li>Rem distinctio dolorum nesciunt animi magni officia, ipsum laborum eum quis quam alias porro, aperiam eos
            expedita perferendis error quas hic. Obcaecati cum consequatur ab recusandae, ea iusto. Quasi, obcaecati!
        </li>
    ...
    <p>P - Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error aliquid unde iste ab id, pariatur sed neque
    ...
    <blockquote>BLOCKQUOTE - Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos nemo, dolorem aut architecto
        libero aliquid. Quo impedit itaque totam nobis facilis voluptatem architecto porro aliquam non fugiat. Quidem,
