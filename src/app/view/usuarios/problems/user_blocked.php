...
<body>
    ...
    <section class="container">
        ...
        <?= $this->render('usuarios/problems/inc/topbar', [
            'defaultImage' => baseurl('statics/login-and-recovery/images/problems/forms/u-error-block.svg'),
            'altImage' => baseurl('statics/login-and-recovery/images/problems/forms/u-error-block.svg'),
        ...
        <?= $this->render('usuarios/problems/inc/topbar', [
            'defaultImage' => baseurl('statics/login-and-recovery/images/problems/forms/u-error-block.svg'),
            'altImage' => baseurl('statics/login-and-recovery/images/problems/forms/u-error-block.svg'),
            'headerText' => 'Usuario desbloqueado',
            'classesCSS' => "five",
            'active' => false,
        ]); ?>
