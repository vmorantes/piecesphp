...
return [
    ...
    "Descripción_Seguridad_e_IA" => 'Configuraciones de seguridad y modelos de inteligencia artificial',
    "Descripción_Email" => 'Configurar credenciales de correo electrónico para envíos desde la plataforma',
    "Descripción_OsTicket" => 'Configurar sistema de tickets OsTicket',
    "Descripción_Routes_And_Permissions" => 'Detalle de rutas registradas y sus permisos asociados',
];
