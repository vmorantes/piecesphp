...
return [
    ...
    'Código de área' => 'Code de zone',
    'Seleccione una nacionalidad' => 'Sélectionnez une nationalité',
    "Activo" => "Actif",
    "Inactivo" => "Inactif",
    "Segundo nombre (opcional)" => "Deuxième prénom (optionnel)",
    "Primer nombre" => "Premier prénom",
    "Segundo apellido (opcional)" => "Deuxième nom de famille (optionnel)",
    "Investigación" => "Recherche",
    "Colaboración Bilateral" => "Collaboration bilatérale",
