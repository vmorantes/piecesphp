 ...
 */
//No hay 'es' porque el CKEditor vendorizado NO trae `translations/es.js`: son 63 y ese no
//está, así que en español el editor se queda en su inglés de fábrica. No es un olvido.
$ckeditorLangs = [
