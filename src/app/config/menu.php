...
$config['menus']['sidebar'] = new MenuGroupCollection([
    'items' => [
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Artículos'),
            'icon' => 'newspaper',
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Categorías'),
            'icon' => 'tags',
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Ubicaciones'),
            'icon' => 'marker',
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Noticias'),
            'icon' => 'newspaper',
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Gestionar usuarios'),
            'icon' => 'user',
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Informes de ingreso'),
            'icon' => 'file',
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Importar usuarios'),
            'icon' => 'upload',
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Mensajes'),
            'attributes' => [
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Opciones de usuario'),
            'icon' => 'user cog',
            'visible' => true,
            'asLink' => true,
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Personalización'),
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Configuraciones'),
            'icon' => 'cogs',
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Log de errores'),
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Soporte técnico'),
            'icon' => 'question',
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Rutas y permisos'),
        ...
        new MenuGroup([
            'name' => __('sidebar_admin', 'Cerrar sesión'),
            'icon' => 'share',
            'visible' => true,
            'asLink' => false,
			'attributes' => [
