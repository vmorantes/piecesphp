...
window.addEventListener('canDeleteOrganization', function (e) {

	const langGroup = 'appOrganizationsLang'
	const deleteButtons = document.querySelectorAll('[delete-organization-button]')
