 ...
 * @returns {InterestResearchAreaAdapter}
 */
function InterestResearchAreaAdapter(options) {
	/**
	 ...
	 * @property {String} [containerSelector=[interest-research-areas-js]]
	 * @property {String} [loadMoreTriggerSelector=[interest-research-areas-load-more-js]]
	 * @property {Boolean} [scrollToOnLoadMore=[false]]
	 */

	/** @constant {string} */
	const langGroup = 'InterestResearchAreaAdapter'

	/** @constant {string} */
	const LOADER_NAME = 'InterestResearchAreaAdapter'

	/**  @property {InterestResearchAreaAdapter} */
	let instance = this
	...
	let prevPage = 1
	/** @property {String} */
	let containerSelector = '[interest-research-areas-js]'
	/** @property {String} */
	let loadMoreTriggerSelector = '[interest-research-areas-load-more-js]'
	/** @property {String|URL} */
	let requestURL = ''
