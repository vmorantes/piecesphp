...
<section class="module-view-container">
    ...
    <div class="limiter-content">
        ...
        <form method='POST' action="<?= $action; ?>" class="ui form interest-research-areas">
            ...
            <div class="container-standard-form">
                ...
                <div class="ui tab active" data-tab="basic">
                        ...
                        <div class="ui stackable grid">
                            ...
                            <div class="eight wide column">
                                <div class="field required">
                                    ...
                                    <input required type="text" name="areaName[<?= $lang; ?>]" maxlength="1200" value="<?= $element->getLangData($lang, 'areaName', false, ''); ?>">
                                </div>
                            </div>
                            <?php endforeach; ?>
                        </div>
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="color" value="<?= $element->color; ?>" color-picker-js>
                    </div>
            ...
            <div class="field">
                <div class="ui right floated buttons">
                    ...
                    <?php if($allowDelete): ?>
                    <button data-tab-related="basic" type="submit" class="ui button brand-color alt2" delete-interest-research-area-button data-route="<?= $deleteRoute; ?>"><?= __($langGroup, 'Eliminar'); ?></button>
                    <?php endif; ?>
                </div>
            </div>
