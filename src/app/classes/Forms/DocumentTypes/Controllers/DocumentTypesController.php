...
namespace Forms\DocumentTypes\Controllers;
...
use Forms\DocumentTypes\Exceptions\SafeException;
 ...
 *
 * @package     Forms\DocumentTypes\Controllers
 * @author      Vicsen Morantes <sir.vamb@gmail.com>
 * @copyright   Copyright (c) 2022
 */
class DocumentTypesController extends AdminPanelController
{

    /**
     * @var string
     */
    protected static $URLDirectory = 'document-types';
    /**
     * @var string
     */
    protected static $baseRouteName = 'document-types-admin';
    /**
     * @var string
     */
    protected static $title = 'Tipo de documento';
    /**
     * @var string
     */
    ...
    const UPLOAD_DIR = 'document-types';
    ...
    public function __construct()
    {
        ...
        add_global_asset(DocumentTypesRoutes::staticRoute('globals-vars.css'), 'css');
        add_global_asset(DocumentTypesRoutes::staticRoute(self::BASE_CSS_DIR . '/document-types-style.css'), 'css');
    ...
    public function listView(Request $request, Response $response)
    {
        ...
        $backLink = DocumentsController::routeName('list');
        ...
        set_custom_assets([
            DocumentTypesRoutes::staticRoute(self::BASE_JS_DIR . '/utils.js'),
            DocumentTypesRoutes::staticRoute(self::BASE_JS_DIR . '/delete-config.js'),
            DocumentTypesRoutes::staticRoute(self::BASE_JS_DIR . '/list.js'),
        ], 'js');
    ...
    public function addForm(Request $request, Response $response)
    {
        ...
        set_custom_assets([
            DocumentTypesRoutes::staticRoute(self::BASE_JS_DIR . '/utils.js'),
            DocumentTypesRoutes::staticRoute(self::BASE_JS_DIR . '/delete-config.js'),
            DocumentTypesRoutes::staticRoute(self::BASE_JS_DIR . '/add-form.js'),
        ], 'js');
    ...
    public function editForm(Request $request, Response $response)
    {
        ...
        $element = new DocumentTypesMapper($id);

        if ($element->id !== null && DocumentTypesMapper::existsByID($element->id)) {

            import_simple_upload_placeholder();
            set_custom_assets([
                DocumentTypesRoutes::staticRoute(self::BASE_JS_DIR . '/utils.js'),
                DocumentTypesRoutes::staticRoute(self::BASE_JS_DIR . '/delete-config.js'),
                DocumentTypesRoutes::staticRoute(self::BASE_JS_DIR . '/edit-form.js'),
            ], 'js');
    ...
    public function action(Request $request, Response $response)
    {
        ...
        $resultOperation = new ResultOperations([], __(self::LANG_GROUP, 'Tipo de documento'));
        ...
        $notExistsMessage = __(self::LANG_GROUP, 'El tipo de documento que intenta modificar no existe.');
        $successCreateMessage = __(self::LANG_GROUP, 'Tipo de documento creado.');
        ...
        try {
            ...
            try {
                ...
                if (!$isEdit) {
                    ...
                    $mapper->setLangData($lang, 'documentTypeName', $documentTypeName);
                    ...
                    $mapper = new DocumentTypesMapper((int) $id);
    ...
    public function toDelete(Request $request, Response $response, array $args)
    {
        ...
        $resultOperation = new ResultOperations([], __(self::LANG_GROUP, 'Eliminar tipo de documento'));
        $resultOperation->setSingleOperation(true); //Se define que es de una única operación
        ...
        //Mensajes de respuesta
        $notExistsMessage = __(self::LANG_GROUP, 'El tipo de documento que intenta eliminar no existe.');
        $successMessage = __(self::LANG_GROUP, 'Tipo de documento eliminado.');
        $unknowErrorMessage = __(self::LANG_GROUP, 'Ha ocurrido un error desconocido.');
        $unknowErrorWithValuesMessage = __(self::LANG_GROUP, 'Ha ocurrido un error desconocido al procesar los valores ingresados.');
        ...
        try {
            ...
            try {
                ...
                if ($exists) {
                    ...
                    $table = DocumentTypesMapper::TABLE;
                    $inactiveStatus = DocumentTypesMapper::STATUS_INACTIVE;
    ...
    {
        $status = DocumentTypesMapper::STATUS_ACTIVE;
        ...
        $selectFields = DocumentTypesMapper::fieldsToSelect();
        ...
        $result = DataTablesHelper::process([
            ...
            'on_set_data' => function ($e) {
                ...
                if ($hasDelete) {
                    ...
                    $deleteButton = "<a data-route='{$deleteLink}' class='ui button brand-color alt2 icon' delete-document-types-button><i class='trash icon'></i></a>";
    ...
    public static function _all(
        ...
        $table = DocumentTypesMapper::TABLE;
        $fields = DocumentTypesMapper::fieldsToSelect();
        $jsonExtractExists = DocumentTypesMapper::jsonExtractExistsMySQL();
        ...
        $sqlSelect .= " ORDER BY " . implode(', ', DocumentTypesMapper::ORDER_BY_PREFERENCE);
    ...
    {
        return (new DocumentTypesController)->render((mb_strlen(self::BASE_VIEW_DIR) > 0 ? self::BASE_VIEW_DIR . '/' : '') . trim($name, '/'), $data, $mode, $format);
    }
    ...
    private static function _allowedRoute(string $name, string $route, array $params = [])
    {
        ...
        if ($allow) {
            ...
            if ($currentUser !== null) {
                ...
                $canViewAll = in_array($currentUserType, DocumentTypesMapper::CAN_VIEW_ALL);
                $candAddAll = in_array($currentUserType, DocumentTypesMapper::CAN_ADD_ALL);

                if ($name == 'actions-delete') {

                    $allow = false;
                    $id = $params['id'];
                    $element = DocumentTypesMapper::getBy($id, 'id');
                    ...
                    if ($element !== null) {
                        ...
                        if (in_array($currentUserType, DocumentTypesMapper::CAN_DELETE_ALL)) {
                            $allow = true;
                        }
                    ...
                    if ($id !== null) {
                        ...
                        if ($element !== null) {
                            ...
                            if (in_array($currentUserType, DocumentTypesMapper::CAN_EDIT_ALL)) {
                                $allow = true;
                            }
    ...
    protected static function handlerUpload(string $nameOnFiles, string $folder, string $currentRoute = null, array $allowedTypes = null, bool $setNameByInput = true, string $name = null)
    {
        ...
        if ($handler->hasInput()) {
            ...
            try {
                ...
                $instance = new DocumentTypesController;
