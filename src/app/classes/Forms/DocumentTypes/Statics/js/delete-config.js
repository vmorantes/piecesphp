...
window.addEventListener('canDeleteDocumentType', function (e) {

	const langGroup = 'appDocumentTypesLang'
	const deleteButtons = document.querySelectorAll('[delete-document-types-button]')
