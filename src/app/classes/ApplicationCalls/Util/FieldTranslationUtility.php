...
class FieldTranslationUtility
{
     ...
     */
    public function __construct(ApplicationCallsMapper $mapper, string $fieldName, string $baseLang, string $currentLang, bool $translatable = false)
    {
        $this->mapper = $mapper;
    ...
    /**
     * @param ?ApplicationCallsMapper $value
     * @return static|string
     */
    public function mapper(?ApplicationCallsMapper $value = null)
    {
        $propertyName = 'mapper';
        if ($value !== null) {
