...
<section class="module-view-container">
    ...
    <div class="limiter-content">
        ...
        <form method='POST' action="<?= $action; ?>" class="ui form application-calls initial">
                ...
                <div class="ui tab active" data-tab="basic">
                        ...
                        <div class="ui stackable grid">
                            ...
                            <div class="eight wide column">
                                <div class="field required">
                                    ...
                                    <input required type="text" name="title[<?= $lang; ?>]" maxlength="300">
                                </div>
                            </div>
                            <?php endforeach; ?>
                        </div>
                    ...
                    <div class="three fields">
                        ...
                        <div class="field required">
                            ...
                            <div class="ui input left icon">
                                <input type="number" step="any" name="amount" value="0" required>
                    ...
                    <div class="two fields">
                        <div class="field required">
                            ...
                            <input required type="url" name="applicationLink">
                        </div>
                        <div class="field">
                            <div class="two fields">
                                ...
                                <div class="field required" calendar-group-js='periodo' start>
                                    ...
                                    <input required type="text" name="startDate" autocomplete="off">
                                </div>
                        ...
                        <div class="ui stackable grid">
                            ...
                            <div class="eight wide column">
                                <div class="field required">
                                    ...
                                    <div rich-editor-adapter-component="<?= $lang; ?>"></div>
                                    <textarea name="content[<?= $lang; ?>]" required></textarea>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        </div>
