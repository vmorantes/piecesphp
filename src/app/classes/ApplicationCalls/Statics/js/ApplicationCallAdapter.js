 ...
 * @returns {ApplicationCallAdapter}
 */
function ApplicationCallAdapter(options) {
	/**
	 ...
	 * @property {String} [containerSelector=[application-calls-js]]
	 * @property {String} [loadMoreTriggerSelector=[application-calls-load-more-js]]
	 * @property {Boolean} [scrollToOnLoadMore=[false]]
	 */

	/** @constant {string} */
	const langGroup = 'ApplicationCallAdapter'

	/** @constant {string} */
	const LOADER_NAME = 'ApplicationCallAdapter'

	/**  @property {ApplicationCallAdapter} */
	let instance = this
	...
	let prevPage = 1
	/** @property {String} */
	let containerSelector = '[application-calls-js]'
	/** @property {String} */
	let loadMoreTriggerSelector = '[application-calls-load-more-js]'
	/** @property {String|URL} */
	let requestURL = ''
