...
/**
 * ApplicationCallsMapper.
 *
 * @package     ApplicationCalls\Mappers
 ...
 * @property int[]|CountryMapper[] $targetCountries
 * @property string $currency
 * @property double $amount
 * @property int[]|InterestResearchAreasMapper[] $interestResearhAreas
 * @property string[] $participatingInstitutions
...
class ApplicationCallsMapper extends EntityMapperExtensible
{
    ...
    const TABLE = 'application_calls_elements';
    const VIEW_ACTIVE_DATE = 'application_calls_active_date_elements';
    ...
    const CONTENT_TYPE_BILATERAL_PROJECT = 'BILATERAL_PROJECT';
    const CONTENT_TYPE_FUNDING_OPPORTUNITY = 'FUNDING_OPPORTUNITY';
    const CONTENT_TYPES = [
        self::CONTENT_TYPE_BILATERAL_PROJECT => 'Proyecto de cooperación bilateral',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY => 'Oportunidad de financiación',
    ];

    const FINANCING_TYPE_NA = 'N_A';
    const FINANCING_TYPE_GRANT = 'GRANT';
    const FINANCING_TYPE_TENDER = 'TENDER';
    const FINANCING_TYPES = [
        self::FINANCING_TYPE_NA => 'Sin especificar',
        self::FINANCING_TYPE_GRANT => 'Subvención',
        self::FINANCING_TYPE_TENDER => 'Licitación',
    ];

    const CONTENT_TYPES_FOR_FULL_DISPLAY = [
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_NA => 'Proyecto de cooperación bilateral',
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_GRANT => 'Proyecto de cooperación bilateral (Subvención)',
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_TENDER => 'Proyecto de cooperación bilateral (Licitación)',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_NA => 'Oportunidad de financiación',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_GRANT => 'Oportunidad de financiación (Subvención)',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_TENDER => 'Oportunidad de financiación (Licitación)',
    ];
    const CONTENT_TYPES_ICONS = [
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_NA => 'handshake outline',
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_GRANT => 'handshake outline',
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_TENDER => 'handshake outline',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_NA => 'dollar sign',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_GRANT => 'dollar sign',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_TENDER => 'dollar sign',
    ];
    const CONTENT_TYPES_ICONS_COLORS = [
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_NA => '#21BA45',
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_GRANT => '#21BA45',
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_TENDER => '#21BA45',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_NA => '#21AB88',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_GRANT => '#21AB88',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_TENDER => '#21AB88',
    ];
    const CONTENT_TYPES_BG_COLOR = [
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_NA => 'rgba(153, 194, 33, 0.2)',
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_GRANT => 'rgba(153, 194, 33, 0.2)',
        self::CONTENT_TYPE_BILATERAL_PROJECT . '_' . self::FINANCING_TYPE_TENDER => 'rgba(153, 194, 33, 0.2)',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_NA => 'rgba(33, 171, 136, 0.1)',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_GRANT => 'rgba(33, 171, 136, 0.1)',
        self::CONTENT_TYPE_FUNDING_OPPORTUNITY . '_' . self::FINANCING_TYPE_TENDER => 'rgba(33, 171, 136, 0.1)',
    ];
    ...
    public function __construct(int $value = null, string $fieldCompare = 'primary_key')
    {
        ...
        $this->addMetaProperty(new MetaProperty(MetaProperty::TYPE_ARRAY_MAPPER, [], false, InterestResearchAreasMapper::class, 'id'), 'interestResearhAreas');
    ...
    /**
     * Devuelve el contentType para humanos
     * @param bool $langSensitive
     * @return string
     */
    public function financingTypeText(bool $langSensitive = true)
    {
        $financingType = $this->financingType;
        $financingTypes = $langSensitive ? self::financingTypes() : self::FINANCING_TYPES;
        $contentTypeText = array_key_exists($financingType, $financingTypes) ? $financingTypes[$financingType] : '';
     ...
     * @return string
     */
    public function contentTypeText(bool $langSensitive = true)
    {
        $contentType = $this->contentType;
        $contentTypes = $langSensitive ? self::contentTypes() : self::CONTENT_TYPES;
        $contentTypeText = array_key_exists($contentType, $contentTypes) ? $contentTypes[$contentType] : '';
        return $contentTypeText;
    }
    ...
    public function contentTypeForFullDisplayText(bool $langSensitive = true)
    {
        $contentType = $this->contentType;
        $financingType = $this->financingType;
        $mergeType = $contentType . '_' . $financingType;
        $contentTypesForFullDisplay = $langSensitive ? self::contentTypesForFullDisplay() : self::CONTENT_TYPES_FOR_FULL_DISPLAY;
        $contentTypesForFullDisplayText = array_key_exists($mergeType, $contentTypesForFullDisplay) ? $contentTypesForFullDisplay[$mergeType] : '';
        return $contentTypesForFullDisplayText;
    ...
    public function contentTypeIcon()
    {
        ...
        $financingType = $this->financingType;
        $mergeType = $contentType . '_' . $financingType;
        $contentTypesIcons = self::CONTENT_TYPES_ICONS;
        $contentIcon = array_key_exists($mergeType, $contentTypesIcons) ? $contentTypesIcons[$mergeType] : 'project diagram';
        return $contentIcon;
    }
    ...
    public function contentTypeIconColor()
    {
        ...
        $financingType = $this->financingType;
        $mergeType = $contentType . '_' . $financingType;
        $colors = self::CONTENT_TYPES_ICONS_COLORS;
        $color = array_key_exists($mergeType, $colors) ? $colors[$mergeType] : '';
        return $color;
    }
    ...
    public function contentTypeBackgroundColor()
    {
        ...
        $financingType = $this->financingType;
        $mergeType = $contentType . '_' . $financingType;
        $colors = self::CONTENT_TYPES_BG_COLOR;
        $color = array_key_exists($mergeType, $colors) ? $colors[$mergeType] : '';
        return $color;
    }
     ...
     * @param bool $asMapper
     * @return AttachmentApplicationCallsMapper[]
     */
    public function getAttachments(bool $onlyCurrentLang = false, bool $asMapper = false)
    {
        $attachments = AttachmentApplicationCallsMapper::allBy('applicationCall', $this->id, $asMapper, $onlyCurrentLang);
        return $attachments;
    }
    ...
    {
        $attachments = AttachmentApplicationCallsMapper::allBy('applicationCall', $this->id, $asMapper, false, $lang);
        return $attachments;
    }
    ...
    /**
     * @param bool $includeCurrentLang
     * @return string[]
     */
    public function getURLAlternatives(bool $includeCurrentLang = false)
    {
        ...
        foreach ($allowedLangs as $lang) {
            $existOnLang = $this->hasLang($lang);
            if ($existOnLang) {
                $isSameLang = $lang == $currentLang;
                if (!$isSameLang || $includeCurrentLang) {
                    $url = ApplicationCallsPublicController::routeName('single', ['slug' => $this->getSlug($lang)]);
    ...
    protected static function fieldsToSelect(string $formatDate = null)
    {
        ...
        //Países
        $targetCountries = "JSON_UNQUOTE(JSON_EXTRACT({$table}.meta, '$.targetCountries'))";
        $targetCountriesNameSubQuery = "SELECT GROUP_CONCAT({$tableCountry}.name SEPARATOR ', ') FROM {$tableCountry} WHERE JSON_CONTAINS({$targetCountries}, {$tableCountry}.id)";
        ...
        $financingTypesJSON = escapeString(json_encode((object) self::financingTypes(), \JSON_UNESCAPED_UNICODE));
        $contentTypesJSON = escapeString(json_encode((object) self::contentTypes(), \JSON_UNESCAPED_UNICODE));
        $isActiveByDate = "(SELECT COUNT({$tableView}.id) > 0 FROM {$tableView} WHERE {$tableView}.id = {$table}.id)";

        $fields = [
            "LPAD({$table}.id, 5, 0) AS idPadding",
            "JSON_UNQUOTE(JSON_EXTRACT('{$financingTypesJSON}', CONCAT('$.', {$table}.financingType))) AS financingTypeText",
            "JSON_UNQUOTE(JSON_EXTRACT('{$contentTypesJSON}', CONCAT('$.', {$table}.contentType))) AS contentTypeText",
            "CONCAT((SELECT contentTypeText), ' (', (SELECT financingTypeText), ')') AS contentTypeAndFinancingTypeText",
            ...
            "({$targetCountriesNameSubQuery}) AS targetCountriesNames",
     ...
     *
     * @param \stdClass|ApplicationCallsMapper|int $elementOrID
     * @param string $lang
     * @return string
     */
    public static function elementFriendlySlug($elementOrID, string $lang = null)
    {
        ...
        if ($elementOrID instanceof ApplicationCallsMapper && $elementOrID->id !== null) {
    ...
    {
        $options = [];
        foreach (self::CONTENT_TYPES as $value => $text) {
            $options[$value] = __(self::LANG_GROUP, $text);
        }
        return $options;
    }
     ...
     * @return array
     */
    public static function contentTypesForFullDisplay()
    {
        $options = [];
        foreach (self::CONTENT_TYPES_FOR_FULL_DISPLAY as $value => $text) {
            $options[$value] = __(self::LANG_GROUP, $text);
        }
        return $options;
    }
     ...
     * @return array
     */
    public static function financingTypes()
    {
        $options = [];
        foreach (self::FINANCING_TYPES as $value => $text) {
            $options[$value] = __(self::LANG_GROUP, $text);
        }
        return $options;
    }
     ...
     * @return array
     */
    public static function contentTypesForSelect(string $defaultLabel = '', string $defaultValue = '')
    {
        $defaultLabel = strlen($defaultLabel) > 0 ? $defaultLabel : __(self::LANG_GROUP, 'Seleccione');

        $options = [];
        $options[$defaultValue] = $defaultLabel;

        foreach (self::contentTypes() as $key => $value) {
            $options[$key] = $value;
        }
     ...
     * @return array
     */
    public static function contentTypesForFullDisplayForSelect(string $defaultLabel = '', string $defaultValue = '')
    {
        $defaultLabel = strlen($defaultLabel) > 0 ? $defaultLabel : __(self::LANG_GROUP, 'Seleccione');
        ...
        foreach (self::contentTypesForFullDisplay() as $key => $value) {
            $options[$key] = $value;
        }
     ...
     * @return array
     */
    public static function currenciesForSelect(string $defaultLabel = '', string $defaultValue = '')
    {
        $defaultLabel = strlen($defaultLabel) > 0 ? $defaultLabel : __(self::LANG_GROUP, 'Seleccione');
     ...
     * @return array
     */
    public static function financingTypesForSelect(string $defaultLabel = '', string $defaultValue = '')
    {
        $defaultLabel = strlen($defaultLabel) > 0 ? $defaultLabel : __(self::LANG_GROUP, 'Seleccione');
        ...
        foreach (self::financingTypes() as $key => $value) {
            $options[$key] = $value;
        }
    ...
    {
        return (new ApplicationCallsMapper)->getModel();
    }
}
