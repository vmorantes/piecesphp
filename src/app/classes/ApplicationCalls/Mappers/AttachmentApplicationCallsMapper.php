...
/**
 * AttachmentApplicationCallsMapper.php
 */
...
/**
 * AttachmentApplicationCallsMapper.
 *
 * @package     ApplicationCalls\Mappers
 * @author      Vicsen Morantes <sir.vamb@gmail.com>
 * @copyright   Copyright (c) 2025
 * @property int|null $id
 * @property int|ApplicationCallsMapper $applicationCall
 ...
 */
class AttachmentApplicationCallsMapper extends EntityMapperExtensible
{
    protected $fields = [
        'id' => [
            'type' => 'int',
        ...
        'applicationCall' => [
            'type' => 'int',
            'reference_table' => ApplicationCallsMapper::TABLE,
            'reference_field' => 'id',
            'reference_primary_key' => 'id',
            'human_readable_reference_field' => 'id',
            'mapper' => ApplicationCallsMapper::class,
        ],
        'attachmentName' => [
            'type' => 'text',
        ],
    ...
    const TABLE = 'application_calls_attachments';
    ...
    protected static function fieldsToSelect()
    {
        ...
        $mapper = new AttachmentApplicationCallsMapper;
    ...
    public static function getExactAttachment(int $applicationCallID, int $attachmentID, string $lang, bool $asMapper = false)
    {
        ...
        $where = [
            'applicationCall' => $applicationCallID,
            'id' => $attachmentID,
            'lang' => $lang,
        ];
        ...
        if (!is_null($result) && $asMapper) {
            $result = new AttachmentApplicationCallsMapper($result->id);
        }
    ...
    public static function existsByApplicationCall(int $applicationCallID, string $lang = null, int $ignoreID = null)
    {
        ...
        $where = [
            "applicationCall = {$applicationCallID} AND",
            "id != {$ignoreID}",
        ];
    ...
    {
        return (new AttachmentApplicationCallsMapper)->getModel();
    }
}
