...
window.addEventListener('canDeleteSuscriber', function (e) {

	const langGroup = 'appNewsletterLang'
	const deleteButtons = document.querySelectorAll('[delete-newsletter-suscriber-button]')
