...
namespace PiecesPHP\BuiltIn\Shop\Brand\Mappers;
 ...
 * BrandMapper.
 *
 * @package     PiecesPHP\BuiltIn\Shop\Brand\Mappers
 ...
 */
class BrandMapper extends EntityMapperExtensible
{
    ...
    const TABLE = 'pcsphp_shop_brands';
