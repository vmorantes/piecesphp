            ...
            <form method='POST' action="<?= $action; ?>" class="ui form built-in-banner">
                ...
                <div class="ui tab active" data-tab="basic">
                    ...
                    <div class="form-attachments-regular">
                        <div class="attach-placeholder desktop-image required">
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="orderPosition" value="0" min="0">
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="title" maxlength="300" placeholder="">
                    </div>
