...
/**
 * OrganizationPreviousExperiencesMapper.php
 */
...
/**
 * OrganizationPreviousExperiencesMapper.
 *
 ...
 * @property int|OrganizationMapper $profile
 ...
 */
class OrganizationPreviousExperiencesMapper extends EntityMapperExtensible
{
    ...
    const SLUG_NAME_FIELD = 'experienceName';
    ...
    protected $fields = [
        ...
        'profile' => [
            'type' => 'int',
            'reference_table' => OrganizationMapper::TABLE,
            'reference_field' => 'id',
    ...
    const TABLE = 'organization_previous_experiences';
     ...
     * @return OrganizationPreviousExperiencesMapper|null
     *
    ...
    {
        return (new OrganizationPreviousExperiencesMapper)->getModel();
    }
}
