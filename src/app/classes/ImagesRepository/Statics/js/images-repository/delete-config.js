...
window.addEventListener('canDeleteImageRepository', function (e) {

	const langGroup = 'appImagesRepositoryLang'
	const deleteButtons = document.querySelectorAll('[delete-images-repository-button]')
