...
window.addEventListener('canDeletePreviousOrganizationExperience', function (e) {

	const langGroup = 'previousOrganizationExperiencesLang'
				...
				click: function () {
					...
					postRequest(routeDelete).then(function (res) {
						...
						if (success) {
							...
							window.dispatchEvent(new Event('wasDeletedPreviousExperience'))
