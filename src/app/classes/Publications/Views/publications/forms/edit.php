            ...
            <form method='POST' action="<?= $action; ?>" class="ui form publications">
                    ...
                    <div class="form-attachments-regular">
                        <div class="attach-placeholder main-image required">
                            ...
                            <label for="<?= $uniqueIdentifier; ?>">
                                <div data-image="<?= $element->getLangData($lang, 'mainImage', false, ''); ?>" class="image" data-on-change-text="<?= __($langGroup, 'Cambiar'); ?>">
                        ...
                        <div class="attach-placeholder thumb-image required">
                            ...
                            <label for="<?= $uniqueIdentifier; ?>">
                                <div data-image="<?= $element->getLangData($lang, 'thumbImage', false, ''); ?>" class="image" data-on-change-text="<?= __($langGroup, 'Cambiar'); ?>">
                                    <i class="icon upload"></i>
                                    <div class="caption"><?= __($langGroup, 'Anexar'); ?></div>
                                </div>
                                <div class="text">
                ...
                <div class="ui tab" data-tab="seo">
                    ...
                    <div class="attach-placeholder og-image">
                        ...
                        <label for="<?= $uniqueIdentifier; ?>">
                            <div data-image="<?= $element->getLangData($lang, 'ogImage', false, ''); ?>" class="image" data-on-change-text="<?= __($langGroup, 'Cambiar'); ?>">
                                <i class="icon upload"></i>
                                <div class="caption"><?= __($langGroup, 'Anexar'); ?></div>
                            </div>
                            <div class="text">
    ...
    $croppers = [
        ...
        [
            ...
            'cropperOptions' => [
                ...
                'referenceW' => '1200',
                'referenceH' => '600',
                'image' => $element->getLangData($lang, 'ogImage'),
