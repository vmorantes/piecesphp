 ...
 * @property int $order
 * @property int|PresentationCategoryMapper $category
 * @property string|array|\stdClass $images
 * @property \stdClass|string|null $meta
 * @property \stdClass|null $lang_data
 */
class PresentationMapper extends EntityMapperExtensible
{
    ...
    protected $fields = [
        ...
        'category' => [
            'type' => 'int',
            'reference_table' => PresentationCategoryMapper::TABLE,
            'reference_field' => 'id',
            'reference_primary_key' => 'id',
            'mapper' => PresentationCategoryMapper::class,
        ],
        'images' => [
            'type' => 'json',
            'null' => false,
     ...
     *
     * @param \stdClass|PresentationMapper|int $elementOrID
     * @return string
     */
    public static function elementFriendlySlug($elementOrID)
    {
        ...
        if ($elementOrID instanceof PresentationMapper && $elementOrID->id !== null) {
