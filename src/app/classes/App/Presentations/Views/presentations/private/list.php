...
<div style="max-width:850px;">
    ...
    <div>
        ...
        <a href="<?= $addLink; ?>" class="ui button teal"><?= __($langGroup, 'Agregar presentación'); ?></a>
        <?php endif; ?>

        <?php if ($hasPermissionsListCategories):  ?>
        <a href="<?= $listCategoriesLink; ?>" class="ui button teal"><?= __($langGroup, 'Categorías'); ?></a>
        <?php endif; ?>

        <?php if ($hasPermissionsAddCategory):  ?>
        <a href="<?= $addCategoryLink; ?>" class="ui button teal"><?= __($langGroup, 'Agregar categoría'); ?></a>
        <?php endif; ?>
