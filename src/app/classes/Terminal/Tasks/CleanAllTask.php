 ...
 */
class CleanAllTask extends TerminalTaskAbstract
{
    ...
    public function __construct(string $startRoute = '', ?string $namePrefix = null)
    {
        ...
        $name = ($namePrefix !== null ? $namePrefix . '-' : '') . 'clean-all';
        ...
        $this->route = "{$startRoute}/clean-all[/]";
    ...
    {
        call_user_func([CleanLogsTask::class, 'main'], $requestRoute, $responseRoute, $parameters);
        call_user_func([CleanCacheTask::class, 'main'], $requestRoute, $responseRoute, $parameters);
    }

    public static function route(string $startRoute = '', ?string $namePrefix = null): Route
    {
        $instance = new CleanAllTask($startRoute, $namePrefix);
        $route = new Route(
            $instance->route,
            $instance->controller,
            $instance->name,
