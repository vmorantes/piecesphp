class UtilPieces {
        ...
        */
        ...
        static numberFormat(number: number, decimals: number, decimal_separator: string, thousands_separator: string): string {
            ...
            var n = !isFinite(+numberString) ? 0 : +numberString,
                ...
                s: string[] = [],
                toFixedFix = function (n: number, prec: number): string {
        ...
        static configContadores(selector: string, step: number = 1, decimals: number = 0, decimal_separator: string = ',', thousands_separator: string = '.', delay: number = 1) {
            ...
            if (contadores.length > 0) {
                ...
                for (var element of contadores) {
                    ...
                    var cantidad = parseFloat(element.getAttribute('data-counter') || '0')
    ...
    html = class {
        ...
        * @returns {HTMLElement}
        */
        static createElement(tag: string, options?: ElementCreationOptions): HTMLElement {
         ...
         * @returns {HTMLElement}
         */
        static createTagInnerHTML(tag: string, innerHTML: string = '', options?: ElementCreationOptions): HTMLElement {
         ...
         * @returns {HTMLElement}
         */
        static create(tag: string, attributes?: Array<{ attr: string, value: string | Array<string> }>, childs?: HTMLElement | Array<HTMLElement>, innerHTML: string = '', options?: ElementCreationOptions): HTMLElement {
