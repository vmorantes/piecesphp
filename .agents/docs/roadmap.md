...
| 7c | **E4 · ventana de correo** | Pruebas de los 10 envíos, en tres capas: composición sin red, sumidero SMTP local y entrega real revisada a mano | `18` T7; ADR 0015 | Parte A y B1 cerradas (`#126`→`#142`: recuperación por código, envíos 6, 8 y 9, escape de las plantillas públicas); B2a en curso (`#165`); faltan B2b (4, 3 y 1) y B3 (Mailinator, ADR 0011). La capa 1 queda absorbida en la 2 salvo el escape de plantillas |
