...
- **Excepción de este repositorio (ADR 0019, 2026-09-16):** arquitecto y coder deciden y crean las versiones y etiquetas del framework, y avanzan `master` y `last-stable`, salvo una versión MAYOR estable, que decido yo. `last-stable` apunta siempre a una versión estable. Mover o borrar una etiqueta, nunca.
