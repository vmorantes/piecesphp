# PiecesPHP Framework
## [Estructura del Framework](./content/structure.md)
## [Despliegue](./content/general.md)
## [Permisos y Propiedad](./content/permissions.md)
...
- **[FreezeRequest](./new-features/freeze-request.md)**: Persistencia de contexto HTTP para ejecución diferida.
